# PSWritePDF Website Content

This folder contains curated source content that the Evotec website imports for the PSWritePDF project page.

## Layout

- `content/project-docs/` contains short project documentation pages shown under /projects/pswritepdf/docs/.
- `content/examples/` contains curated website examples shown under /projects/pswritepdf/examples/.
...
- Keep links rooted at /projects/pswritepdf/ so the same content works on localhost, evotec.xyz, and evotec.pl.
